...
import { Stepper, Step, Button, Textarea } from "@material-tailwind/react";
import {
  HomeIcon,
  CogIcon,
  UserIcon,
...
export default function Signup() {
  const array_prompt = [
    { option: "Server-side rendering is underrated", Id: 1 },
  ...
  return (
    <section className="mx-auto max-w-screen-xl py-20 h-4/6">
      <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden">
        <div className="md:flex w-full">
          <div className="hidden md:block w-1/2  bg-gradient-to-br from-purple-700 to-orange-400 rounded py-10 px-10">
            <svg
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div className="text-center mb-10">
              <h1 className="font-bold text-3xl text-gray-900">TRY IT</h1>
